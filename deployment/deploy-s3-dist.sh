...
#    --stack-name cmf-solution-stack \
#    --template-url https://cmf-deployment-537124965680-us-east-1-reference.s3.us-east-1.amazonaws.com/cloud-migration-factory-on-aws/custom001/aws-cloud-migration-factory-solution.template